...
<div id="context">
   ...
   <script type="text/javascript">
        ...
        (
        {
        url: '<?php echo base_url()?>moderator/administrator/getList',
        dataType: 'json',
        colModel : [
            {display: 'ID', name : 'id', width : 40, sortable : true, align: 'center'},
            {display: 'Username', name : 'username', width : 100, sortable : true, align: 'left'},
            {display: 'Password', name : 'password', width : 250, sortable : true, align: 'left'},
            ],
        buttons : [
        ...
        function test(com,grid){
            if (com=='Delete'){
                ...
                if(($('.trSelected',grid).length>0)&&($('.trSelected',grid).length<2)){
                    ...
                    window.open('<?php echo base_url()?>moderator/administrator/editItem/'+itemlist, '_parent');
                }
            }
        }
    </script>
